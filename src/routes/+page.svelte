<script>
  import { TextBlock } from '$lib/index.js';
  ...
  const textBlockContents = {
    ...
    footnote:
      'Heb je een vraag? Neem dan contact op via <a href="mailto:info-cmd@hva.nl">info-cmd@hva.nl</a>',
    image: {
      src: headerImage,
...
<p>
  Frontend Design & Development (FDND) is an Associate Degree programme at the Amsterdam University
  of Applied Sciences (AUAS). For our microsites we use the components as defined in this NPM
  package. This project is intended for internal use but as we strive to be an open source (GPLv3)
  Higher Ed. programme we intend to share everything that is not GDPR sensitive.
</p>
